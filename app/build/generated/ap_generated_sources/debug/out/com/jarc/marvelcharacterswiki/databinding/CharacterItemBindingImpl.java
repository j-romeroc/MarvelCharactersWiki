...
public class CharacterItemBindingImpl extends CharacterItemBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.characterImg, 1);
        sViewsWithIds.put(R.id.characterInfoLayout, 2);
        sViewsWithIds.put(R.id.tvCharacterName, 3);
        sViewsWithIds.put(R.id.tvCharacterId, 4);
    }
    // views
    // variables
    // values
